...
good:
  ...
  - Ensure you collect a value for a variable called `name` on your form, so that [node labelling](../reference/key-concepts/node-labelling.md) works correctly.
---
