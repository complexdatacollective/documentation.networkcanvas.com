...
![Resource library button](assets/img/roster-tutorial/xx.png "The resource library button from within a protocol in Architect")
...
![Name Generator Roster Interface](/assets/img/roster-tutorial/xx.png "Name Generator Roster Interface showing node select section")
...
![Resource preview button](/assets/img/roster-tutorial/xx.png "Resource selection screen showing the preview button for a resource")

![Resource preview](/assets/img/roster-tutorial/xx.png "Example roster visible within the preview screen")
...
![Roster interface in Interviewer](/assets/img/roster-tutorial/xx.png "Example of a roster interface within Interviewer")
...
![Card display options](/assets/img/roster-tutorial/xx.png "Card display options panel from within Architect")
